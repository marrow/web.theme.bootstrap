...
: def page title, *, header=bootstrap_header, footer=default_footer, metadata=[], styles=[], scripts=[], **attributes
	...
	: scripts = ['//cdn.jsdelivr.net/g/jquery@1.11.3,bootstrap@3.3.5(js/bootstrap.js+js/bootstrap.min.js),fitvids@1.1.0'] + scripts
	...
	: return page_(title, header=header, footer=footer, metadata=metadata, styles=styles, scripts=scripts)
